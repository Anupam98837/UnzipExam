...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('media', function (Blueprint $table) {
            ...
            // File details (stored in public/AllMedia with a unique filename)
            ...
            // Optional tagging to know where it is used from
            // e.g., 'quiz', 'question', 'exam', 'user'
            $table->string('usage_tag', 50)->nullable()->index();
            ...
            // FKs (nullable on delete so media rows stay even if user removed)
        ...
        // Optional FULLTEXT for quick search (MySQL 8+, InnoDB)
        try {
