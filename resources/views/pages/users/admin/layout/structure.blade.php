{{-- resources/views/layouts/admin/structure.blade.php (Unzip Examination) --}}
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width, initial-scale=1"/>
  <title>@yield('title','Unzip Examination Admin')</title>
...
<aside id="sidebar" class="w3-sidebar" aria-label="Sidebar">
  ...
  <div class="w3-sidebar-scroll">
    ...
    <nav class="w3-menu" aria-label="Overview">
      <a href="/admin/dashboard" class="w3-link">
    ...
    <nav class="w3-menu" aria-label="Exam Management">
      ...
      <div class="w3-group">
        ...
        <a href="/admin/quizz/manage" class="w3-link">Manage Quizzes</a>
        <a href="/admin/quizz/results" class="w3-link">Results</a>
        </div>
      </div>
    </nav>
...
<header class="w3-appbar">
  <div class="w3-appbar-inner">
    ...
    <strong class="ms-1 d-none d-lg-inline" style="font-family:var(--font-head);color:var(--ink)">
      @yield('title','Unzip Examination Admin')
    </strong>
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end p-2 shadow" style="min-width:320px">
          ...
          <div class="w3-note rounded-xs">
            <div class="small"><strong>Exam schedule update</strong> — One of today’s exams has been rescheduled.</div>
          </div>
        </div>
      </div>
