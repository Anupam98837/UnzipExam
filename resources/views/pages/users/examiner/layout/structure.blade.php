{{-- resources/views/layouts/examiner/structure.blade.php (Unzip Examination) --}}
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/>
  <meta name="viewport" content="width=device-width, initial-scale=1"/>
  <title>@yield('title','Unzip Examination Examiner')</title>
  ...
  {{-- page-level styles from views (dashboard, quizzes, exams, etc.) --}}
  @stack('styles')
  @yield('styles')
  ...
  <style>
    ...
    /* ===== RTE styles kept (same as W3T/Admin) ===== */
...
<aside id="sidebar" class="w3-sidebar" aria-label="Sidebar">
  <div class="w3-sidebar-head">
    <a href="/examiner/dashboard" class="w3-brand">
  ...
  <div class="w3-sidebar-scroll">
    ...
    <nav class="w3-menu" aria-label="Overview">
      <a href="/examiner/dashboard" class="w3-link">
    ...
    <nav class="w3-menu" aria-label="Exam Management">
      ...
      <div class="w3-group">
        ...
        <div id="sm-quizzes" class="w3-submenu" role="group" aria-label="Quizzes submenu">
          <a href="/examiner/quizz/create" class="w3-link">Create Quiz</a>
          <a href="/examiner/quizz/manage" class="w3-link">Manage Quizzes</a>
          <a href="/examiner/quizz/result/manage" class="w3-link">Results</a>
        </div>
      </div>
    </nav>
...
<header class="w3-appbar">
  <div class="w3-appbar-inner">
    ...
    <!-- Mobile brand -->
    <a href="/examiner/dashboard" class="w3-app-logo d-lg-none">
    ...
    <strong class="ms-1 d-none d-lg-inline" style="font-family:var(--font-head);color:var(--ink)">
      @yield('title','Unzip Examination Examiner')
    </strong>
    ...
    <div class="ms-auto d-flex align-items-center gap-2">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end p-2 shadow" style="min-width:320px">
          <div class="d-flex align-items-center justify-content-between px-2 mb-2">
            ...
            <a class="text-muted" href="/examiner/notifications">View all</a>
          </div>
          <div class="w3-note rounded-xs">
            <div class="small"><strong>Exam update</strong> — One of your assigned exams has been updated.</div>
          </div>
        </div>
      </div>
      ...
      <div class="dropdown d-none d-lg-block">
        <a href="#" class="btn btn-primary rounded-pill d-flex align-items-center gap-2 px-3" id="userMenu" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <span id="userRoleLabel" class="d-none d-xl-inline">Examiner</span>
        </a>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function titleizeRole(r){
    if (!r) return 'Examiner';
    return r.replace(/_/g,' ').replace(/\b\w/g, c => c.toUpperCase());
  }
  const roleFromStorage = sessionStorage.getItem('role') || localStorage.getItem('role');
  roleLabelEl && (roleLabelEl.textContent = titleizeRole(roleFromStorage) || 'Examiner');
