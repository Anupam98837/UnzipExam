...
function normalizeImg(val){
  ...
  try{
    ...
    // if API accidentally returns another host/port, force current origin
    if (u.origin !== location.origin) return location.origin + u.pathname;
    return u.href;
  }catch(e){
...
function loadProfile() {
    ...
    .then(res => {
        ...
        pf_img.src = normalizeImg(user.image);
window.profileApi = endpoints || {};
profileApi = window.profileApi; // ✅ make local variable usable
